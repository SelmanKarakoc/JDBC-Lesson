...
public class JDBC02_execute_executeUpdate {
    ...
    */
        ...
        System.out.println("işlemden etkilenen satir sayisi="+st.executeUpdate(insertData));
...
/*=======================================================================
        ...
        while (iscilerTablosu.next()){
            System.out.println(iscilerTablosu.getInt(1)+" "+iscilerTablosu.getString(2)+
                    " "+iscilerTablosu.getString(3));
        }
    ...
    %10 zam yapiniz
        ...
        /*=======================================================================
	      ORNEK6: isciler tablosunun son halini goruntuleyin.
	     ========================================================================*/
        ...
        /*=======================================================================
     ORNEK7: Isciler tablosundan birimi 'ARGE' olan iscileri siliniz.
        ========================================================================*/

        String deleteArge="delete from isciler where birim='ARGE'";

        int silinenSatir=st.executeUpdate(deleteArge);

        System.out.println(silinenSatir+" tane birimi ARGE olan kayıt silindi");

/*=======================================================================
	      ORNEK8: isciler tablosunun son halini goruntuleyin.
	     ========================================================================*/
        System.out.println("================ Isciler Tablosu Son Hali ================");
